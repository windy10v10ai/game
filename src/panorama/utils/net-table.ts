...
function TransPlayerData(data: NetworkedData<PlayerInfoDto>): PlayerInfoDto {
  ...
  if (data.playerSetting != null) {
    result.playerSetting = {
      ...
      wardObserverKey: data.playerSetting.wardObserverKey,
      wardObserverQuickCast: Boolean(data.playerSetting.wardObserverQuickCast ?? 0),
      wardSentryKey: data.playerSetting.wardSentryKey,
      wardSentryQuickCast: Boolean(data.playerSetting.wardSentryQuickCast ?? 0),
