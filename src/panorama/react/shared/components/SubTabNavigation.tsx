      ...
      {tabs.map((tab) => {
        ...
        return (
          <Button
            ...
            onmouseover={(panel) => { panel.style.brightness = '1.3'; panel.style.borderColor = '#e0caa5aa'; }}
            onmouseout={(panel) => { panel.style.brightness = '1.0'; panel.style.borderColor = isActive ? '#daa520' : '#e0caa544'; }}
          >
