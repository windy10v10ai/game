// 需要与 particles/units/heroes/ 目录下的英雄名一致
export const heroNameListParticles = [
  'hero_abaddon', // 亚巴顿
  'heroes_underlord', // 孽主
  'hero_alchemist', // 炼金术士
  'hero_ancient_apparition', // 远古冰魄
  'hero_antimage', // 敌法师
  // 'hero_arc_warden', // 天穹守望者
  'hero_axe', // 斧王
  // 'hero_batrider', // 蝙蝠骑士
  // 'hero_beastmaster', // 兽王
  'hero_bloodseeker', // 血魔
  'hero_bounty_hunter', // 赏金猎人
  // 'hero_brewmaster', // 酒仙
  // 'hero_bristleback', // 钢背兽
  // 'hero_broodmother', // 育母蜘蛛
  'hero_centaur', // 半人马战行者
  // 'hero_chaos_knight', // 混沌骑士
  // 'hero_chen', // 陈
  'hero_clinkz', // 克林克兹
  // 'hero_crystalmaiden', // 水晶室女
  'hero_dark_seer', // 黑暗贤者
  'hero_dazzle', // 戴泽
  // 'hero_death_prophet', // 死亡先知
  // 'hero_disruptor', // 干扰者
  'hero_doom_bringer', // 末日使者
  'hero_dragon_knight', // 龙骑士
  'hero_drow', // 卓尔游侠
  'hero_earth_spirit', // 大地之灵
  'hero_earthshaker', // 撼地者
  'hero_elder_titan', // 上古巨神
  'hero_ember_spirit', // 灰烬之灵
  'hero_enchantress', // 魅惑魔女
  'hero_enigma', // 谜团
  'hero_faceless_void', // 虚空假面
  // 'hero_furion', // 自然先知
  ...
  'hero_kunkka', // 昆卡
  // 'hero_legion_commander', // 军团指挥官
  // 'hero_leshrac', // 拉席克
  // 'hero_lich', // 巫妖
  'hero_life_stealer', // 噬魂鬼
  'hero_lina', // 莉娜
  'hero_lion', // 莱恩
  // 'hero_lone_druid', // 德鲁伊
  'hero_luna', // 露娜
  ...
  // 'hero_meepo', // 米波
  'hero_mirana', // 米拉娜
  'hero_monkey_king', // 齐天大圣
  // 'hero_morphling', // 变体精灵
  // 'hero_naga_siren', // 娜迦海妖
  'hero_necrolyte', // 死灵法师
  'hero_nevermore', // 影魔
  // 'hero_nightstalker', // 暗夜魔王
  // 'hero_nyx_assassin', // 司夜刺客
  // 'hero_obsidian_destroyer', // 殁境神蚀者
  'hero_ogre_magi', // 食人魔魔法师
  'hero_omniknight', // 全能骑士
  // 'hero_oracle', // 神谕者
  'hero_phantom_assassin', // 幻影刺客
  'hero_phantom_lancer', // 幻影长矛手
  // 'hero_phoenix', // 凤凰
  // 'hero_puck', // 帕克
  'hero_pudge', // 帕吉
  // 'hero_pugna', // 帕格纳
  'hero_queenofpain', // 痛苦女王
  'hero_rattletrap', // 发条技师
  'hero_razor', // 雷泽
  'hero_riki', // 力丸
  'hero_rubick', // 拉比克
  'hero_sandking', // 沙王
  // 'hero_shadow_demon', // 暗影恶魔
  'hero_shadowshaman', // 暗影萨满
  'hero_shredder', // 伐木机
  'hero_silencer', // 沉默术士
  // 'hero_skeletonking', // 骷髅王
  'hero_skywrath_mage', // 天怒法师
  'hero_slardar', // 斯拉达
  'hero_slark', // 斯拉克
  'hero_sniper', // 狙击手
  'hero_spectre', // 幽鬼
  'hero_spirit_breaker', // 裂魂人
  'hero_stormspirit', // 风暴之灵
  'hero_sven', // 斯温
  'hero_techies', // 工程师
  'hero_templar_assassin', // 圣堂刺客
  // 'hero_terrorblade', // 恐怖利刃
  'hero_tidehunter', // 潮汐猎人
  'hero_tinker', // 修补匠
  'hero_tiny', // 小小
  'hero_treant', // 树精卫士
  'hero_troll_warlord', // 巨魔战将
  'hero_tusk', // 巨牙海民
  // 'hero_undying', // 不朽尸王
  'hero_ursa', // 熊战士
  // 'hero_vengefulspirit', // 复仇之魂
  'hero_venomancer', // 剧毒术士
  'hero_viper', // 冥界亚龙
  'hero_visage', // 维萨吉
  // 'hero_warlock', // 术士
  'hero_weaver', // 编织者
  ...
  // 'hero_marci', // 玛西
  // 'hero_snapfire', // 电炎绝手
  // 'hero_dawnbreaker', // 破晓辰星
  // 'hero_hoodwink', // 森海飞霞
  'hero_dark_willow', // 邪影芳灵
  // 'hero_void_spirit', // 虚无之灵
  // 'hero_grimstroke', // 天涯墨客
  'hero_pangolier', // 石鳞剑士
  'hero_muerta', // 琼英碧灵
  'hero_ringmaster', // 百戏大王
  // 'hero_kez', // 凯
];

export const heroNameListSound = [
  ...
  'npc_dota_hero_doombringer', // 末日使者
...
export const abilityModelNameList = [
  ...
  'models/heroes/gyro/gyro_flak_cannon_fx.vmdl', // 高射火炮
  'models/heroes/dragon_knight/dragon_knight_dragon.vmdl', // 变龙
];
