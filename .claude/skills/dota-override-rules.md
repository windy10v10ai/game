...
| 加强方式          | 旧官方值        | 新官方值        | 旧值                | 新值                | 注释                 |
| ----------------- | --------------- | --------------- | ------------------- | ------------------- | -------------------- |
| 固定差异          | 100 120 140 160 | 110 130 150 170 | 110 130 150 170 180 | 120 140 160 180 190 | `// 110 130 150 170` |
| 倍数加强          | 20 25 30 35     | 25 30 35 40     | 40 50 60 70 80      | 50 60 70 80 90      | `// 25 30 35 40 x2`  |
| 调整等差          | 250 350 450     | 300 400 500     | 250 400 550 700     | 300 450 600 750     | `// 300 400 500`     |
| 固定值→随等级增加 | 5               | 6               | 10 15 20 25 30      | 12 18 24 30 36      | `// 6`               |
...
特殊情况 (CD ≤ 5s):
官方 4 级: 8 7 6 5
扩展到 5 级: 9 8 7 6 5 (添加第5级，保持最大值不变，等差过小时保持等差不变)

官方 4 级: 20 15 10 5
扩展到 5 级: 21 17 13 9 5 (添加第5级，保持最大值不变，等差过大时调整等差)
```
...
1. **属性中文名称**（不用英文） 在docs\reference\7.40\abilities_schinese.txt中查找
2. **当前 override 值**
3. **新官方值**
4. **建议更新值**
...
| 技能       | 属性       | 旧官方值 | 新官方值 | 旧值   | 新值   |
| ---------- | ---------- | -------- | -------- | ------ | ------ |
| 技能中文名 | 属性中文名 | 旧版官方 | 7.40官方 | 修改前 | 修改后 |
