...
function ItemOrAbilityRow({ data, className, }) {
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, Object.assign({ style: { flowChildren: 'right' } }, { children: data.map((item, index) => (
        // 如果index 是 4，5 的话，就加上一个style 是金边
        (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, Object.assign({ className: className, style: index >= 3 ? { boxShadow: '0 0 5px #ffd700' } : { boxShadow: '0 0 5px #a029af' } }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DOTAAbilityImage, { abilityname: item.name }) }), index))) })));
}
function DrawAbilities() {
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, Object.assign({ id: "DrawAbility" }, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { id: "DrawAbilityTitle", text: "Choose Your Ability" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, Object.assign({ id: "Content" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, Object.assign({ id: "LeftColumn" }, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, Object.assign({ style: { flowChildren: 'right' } }, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { className: "ProjectName", text: "\u9879\u76EE1" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ItemOrAbilityRow, { data: abilities, className: "Item" })] })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Button, Object.assign({ className: "CommonButton" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { text: $.Localize('#item_choice_shuffle') }) })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, Object.assign({ style: { flowChildren: 'right' } }, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { className: "ProjectName", text: "\u9879\u76EE2" }), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ItemOrAbilityRow, { data: items, className: "Item" })] })), (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Button, Object.assign({ className: "CommonButton" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { text: $.Localize('#item_choice_shuffle') }) }))] })) }))] })));
}
function DrawAbility() {
    const [isCollapsed, setIsCollapsed] = react__WEBPACK_IMPORTED_MODULE_4__.useState(true);
    const toggleCollapse = () => {
        setIsCollapsed(!isCollapsed);
    };
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Panel, Object.assign({ id: "CollapseContainer", className: isCollapsed ? 'collapsed' : 'expanded' }, { children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Button, Object.assign({ className: "CollapseButton", onactivate: toggleCollapse }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Label, { text: isCollapsed ? '展开' : '折叠' }) })), !isCollapsed && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Panel, Object.assign({ id: "Content" }, { children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DrawAbilities, {}) })))] })));
}
(0,react_panorama_x__WEBPACK_IMPORTED_MODULE_3__.render)((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(DrawAbility, {}), $.GetContextPanel());
