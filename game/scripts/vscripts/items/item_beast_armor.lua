...
function modifier_item_beast_armor_debuff:OnCreated()
    if not self:GetAbility() then return end
...
function modifier_item_beast_armor_debuff:GetModifierMoveSpeedBonus_Percentage()
    return -self.movement_slow
end

function modifier_item_beast_armor_debuff:GetModifierAttackSpeedBonus_Constant()
    return -self.attack_slow
end

function modifier_item_beast_armor_debuff:GetModifierMagicalResistanceBonus()
