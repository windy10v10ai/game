...
-- LinkLuaModifier("modifier_item_magic_sword_debuff", "items/item_magic_sword", LUA_MODIFIER_MOTION_NONE)
...
-- 减速debuff modifier
-- ============================================
-- modifier_item_magic_sword_debuff = class({})

-- function modifier_item_magic_sword_debuff:IsHidden() return false end

-- function modifier_item_magic_sword_debuff:IsDebuff() return true end

-- function modifier_item_magic_sword_debuff:IsPurgable() return true end

-- function modifier_item_magic_sword_debuff:OnCreated()
--     if not self:GetAbility() then return end
--     self.slow_pct = self:GetAbility():GetSpecialValueFor("slow_pct") or -30
-- end

-- function modifier_item_magic_sword_debuff:DeclareFunctions()
--     return {
--         MODIFIER_PROPERTY_MOVESPEED_BONUS_PERCENTAGE,
--     }
-- end

-- function modifier_item_magic_sword_debuff:GetModifierMoveSpeedBonus_Percentage()
--     return self.slow_pct or -30
-- end

-- function modifier_item_magic_sword_debuff:GetTexture()
