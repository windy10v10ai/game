...
local TauntMessages = {
    ...
    boss_kill_player = {
        ...
        "我就散个步", "这就倒了?", "菜就多练啊", "还得练啊小老弟儿", "毫无压力", "啥啊，55扎扎的", "别送了"
    },
    ...
    boss_rampage = {
        ...
        "弟弟", "一个能打的都没有",
        "喜欢虐AI是吧？", "无聊", "没意思", "杀得我都累了", "排队送是吧", "能不能认真点？", "这就是你们的全部实力？", "再来十个也没用", "是不是没吃饭？", "打不动我啊", "放弃吧别蹦跶了",
    ...
    player_kill_boss = {
        ...
        "阴啊", "哎呀", "卡", "轻敌了轻敌了", "可以可以", "这波我的", "Hey!", "fk",
        "！", "！", "wtf", "SHIT", "！", "不对不对", "翻了个车" },

    -- 玩家连杀Boss (玩家连续击杀Boss 3次以上)
    player_rampage_boss = {
        "不行不行,我得刷会儿野", "是不是啊,人都没看清就被秒了",
        "畜牲!", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?",
        "你特么", "后里希！", "马泽法克！", "我特么", "错了错了,别打了", "哥,别打了,哥",
        "好好好,这么玩是吧", "我服了", "大佬别充了，服了服了", "我真是", "哪天AI崛起了第一个干你",
        "真的服了", "别打了别打了", "投了投了", "我不服！", "我一定要杀了你", "巴噶！", "sob！", "你这狗东西", "他妈的我好气啊！", "打不过打不过", "这什么伤害", "离谱", "这尼玛",
        "我r啊！", "下把第一个杀你！", "你别让我起来！", "尼格玛德！", "我淦啊！",
        "太离谱了", "这还怎么玩", "不讲武德是吧", "年轻人，讲讲武德啊", "耗子尾汁啊", "我劝你们耗子尾汁啊",
        "不玩了不玩了", "你这伤害开了吧", "见面就秒还玩个屁", "能不能给条活路", "我装备还没齐呢",
        "报警了", "放过孩子吧", "这游戏平衡吗？", "我退群还不行吗", "停手吧", "狗东西", "喂，110吗",
        "*!", "啥啥啥这都是啥", "炸房吧毁灭吧", "你们这帮小老弟儿就看着大哥挨揍是吧", "停手吧",
